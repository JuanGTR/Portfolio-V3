        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"Juan Tejeda"} />
              </h2>
              <h4>
              ...
              <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} onAnimationComplete={() => handleComplete()} className="resume--grid--detail--data--name--icons">
                <a href="https://github.com/JuanGTR" target="_blank" rel="noreferrer">
                  <Icon img={githubIcon} />
                </a>
                <a href="https://www.linkedin.com/in/juan-tejeda-1322ab230/" target="_blank" rel="noreferrer">
                  <Icon img={linkedinIcon} />
                </a>
                <a href="https://docs.google.com/document/d/1JEE1a535h7b6hnShwettHoHyVXjsVx83/edit?usp=sharing&ouid=101719223157469587489&rtpof=true&sd=true" target="_blank" rel="noreferrer">
                  <Icon img={fileIcon} />
                </a>
              </motion.div>
            </div>
